...
describe('dislike analyzer', () => {
	it('likes Monk Skin Tone Scale colors', () => {
		...
		const monkSkinToneScaleColors = [
			0xfff6ede4, 0xfff3e7db, 0xfff7ead0, 0xffeadaba, 0xffd7bd96, 0xffa07e56, 0xff825c43, 0xff604134, 0xff3a312a,
			0xff292420,
		];
	...
	it('dislikes bile colors', () => {
		const unlikable = [0xff95884b, 0xff716b40, 0xffb08e00, 0xff4c4308, 0xff464521];
	...
	it('likes tone 67 colors', () => {
		...
		expect(DislikeAnalyzer.fixIfDisliked(color).toInt()).toBe(color.toInt());
	});
});
